...
insert into categorias (nombre, tipo, categoria_id, descripcion, fecha_guardado) values ('Categoría 3.1', 'INGRESO', 6, '', now());
insert into categorias (nombre, tipo, categoria_id, descripcion, fecha_guardado) values ('Categoría 3.2', 'INGRESO', 6, '', now());

insert into categorias (nombre, tipo, categoria_id, descripcion, fecha_guardado) values ('Categoría 1.4', 'INGRESO', 1, '', now());
insert into categorias (nombre, tipo, categoria_id, descripcion, fecha_guardado) values ('Categoría 2.1', 'INGRESO', 5, '', now());
